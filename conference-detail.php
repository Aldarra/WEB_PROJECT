...
$sql = "SELECT * from conference where id = '".$cid."'";
      ...
      <div class="container">
       ...
       <!-- Navigation menu -->
        <ul class="nav-menu">
          ...
          <li>
            <a href="conferences.php" class="active" >Conferences</a>
        ...
        <div class="header-detail">
          ...
          <div class="button-group">
            ...
            <div class="action-buttons">
               <a class="btn btn-gray" href="#">Edit Conference</a>
            <a class="btn btn-danger" href="#">Delete Conference</a>
            </div>
          </div>
